...
namespace CodeModel.CodeParsers.CSharp
{
    public class ICBMCGraph
    {
        ...
        /// <summary>
        /// Member is normal method if it's not constructor, nor getter or setter,
        ...
        /// <summary>
        /// Graph is disconnected if we can't find all edges in graph
        ...
        /// finds methods that use given field.
        /// </summary>
