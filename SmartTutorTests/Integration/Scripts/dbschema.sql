...
CREATE TABLE "ProjectCheckers" (
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    CONSTRAINT "PK_ProjectCheckers" PRIMARY KEY ("Id")
);


CREATE TABLE "SnippetStrategies" (
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "CodeSnippetId" text NULL,
    "ProjectCheckerId" integer NULL,
    CONSTRAINT "PK_SnippetStrategies" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_SnippetStrategies_ProjectCheckers_ProjectCheckerId" FOREIGN KEY ("ProjectCheckerId") REFERENCES "ProjectCheckers" ("Id") ON DELETE RESTRICT
);
...
CREATE TABLE "ChallengeFulfillmentStrategies" (
    ...
    "SnippetStrategiesId" integer NULL,
    ...
    CONSTRAINT "FK_ChallengeFulfillmentStrategies_SnippetStrategies_SnippetStr~" FOREIGN KEY ("SnippetStrategiesId") REFERENCES "SnippetStrategies" ("Id") ON DELETE RESTRICT
);
...
CREATE INDEX "IX_ChallengeFulfillmentStrategies_SnippetStrategiesId" ON "ChallengeFulfillmentStrategies" ("SnippetStrategiesId");
...
CREATE INDEX "IX_SnippetStrategies_ProjectCheckerId" ON "SnippetStrategies" ("ProjectCheckerId");


ALTER TABLE "MetricRangeRules" ADD CONSTRAINT "FK_MetricRangeRules_BasicMetricCheckers_ClassMetricCheckerFore~" FOREIGN KEY ("ClassMetricCheckerForeignKey") REFERENCES "BasicMetricCheckers" ("Id") ON DELETE RESTRICT;


ALTER TABLE "MetricRangeRules" ADD CONSTRAINT "FK_MetricRangeRules_BasicMetricCheckers_MethodMetricCheckerFor~" FOREIGN KEY ("MethodMetricCheckerForeignKey") REFERENCES "BasicMetricCheckers" ("Id") ON DELETE RESTRICT;


ALTER TABLE "BasicMetricCheckers" ADD CONSTRAINT "FK_BasicMetricCheckers_ChallengeFulfillmentStrategies_Id" FOREIGN KEY ("Id") REFERENCES "ChallengeFulfillmentStrategies" ("Id") ON DELETE CASCADE;


ALTER TABLE "BasicNameCheckers" ADD CONSTRAINT "FK_BasicNameCheckers_ChallengeFulfillmentStrategies_Id" FOREIGN KEY ("Id") REFERENCES "ChallengeFulfillmentStrategies" ("Id") ON DELETE CASCADE;


ALTER TABLE "ProjectCheckers" ADD CONSTRAINT "FK_ProjectCheckers_ChallengeFulfillmentStrategies_Id" FOREIGN KEY ("Id") REFERENCES "ChallengeFulfillmentStrategies" ("Id") ON DELETE CASCADE;
