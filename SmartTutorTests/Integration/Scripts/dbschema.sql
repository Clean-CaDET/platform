...
CREATE TABLE "IndividualPlanUsages" (
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "IndividualPlanId" integer NOT NULL,
    "NumberOfUsersUsed" integer NOT NULL,
    "NumberOfCoursesUsed" integer NOT NULL,
    "NumberOfLecturesUsed" integer NOT NULL,
    CONSTRAINT "PK_IndividualPlanUsages" PRIMARY KEY ("Id")
);
...
CREATE TABLE "Courses" (
    ...
    CONSTRAINT "FK_Courses_Teachers_TeacherId" FOREIGN KEY ("TeacherId") REFERENCES "Teachers" ("Id") ON DELETE RESTRICT
);
...
CREATE INDEX "IX_Subscriptions_TeacherId" ON "Subscriptions" ("TeacherId");
