...
CREATE TABLE "ChallengeFulfillmentStrategies" (
    ...
    "StrategiesApplicableToSnippetCheckerForeignKey" text NULL,
...
CREATE TABLE "ProjectCheckers" (
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "StrategiesApplicableToSnippet" text[] NULL,
    CONSTRAINT "PK_ProjectCheckers" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_ProjectCheckers_ChallengeFulfillmentStrategies_Id" FOREIGN KEY ("Id") REFERENCES "ChallengeFulfillmentStrategies" ("Id") ON DELETE CASCADE  
);
