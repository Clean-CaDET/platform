...
CREATE TABLE "KnowledgeNodes" (
    ...
    CONSTRAINT "FK_KnowledgeNodes_KnowledgeNodes_KnowledgeNodeId" FOREIGN KEY ("KnowledgeNodeId") REFERENCES "KnowledgeNodes" ("Id") ON DELETE RESTRICT,
...
CREATE TABLE "NodeProgresses" (
    ...
    CONSTRAINT "FK_NodeProgresses_Trainees_TraineeId" FOREIGN KEY ("TraineeId") REFERENCES "Trainees" ("Id") ON DELETE RESTRICT
);
...
CREATE INDEX "IX_KnowledgeNodes_KnowledgeNodeId" ON "KnowledgeNodes" ("KnowledgeNodeId");
...
CREATE INDEX "IX_NodeProgresses_TraineeId" ON "NodeProgresses" ("TraineeId");
