...
namespace SmartTutor.Migrations
{
    ...
    [Migration("20210720120353_migration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartTutor.ContentModel.Subscriptions.SubscriptionPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("SubscriptionPlan");
                });
            ...
            modelBuilder.Entity("SmartTutor.ContentModel.Subscriptions.IndividualPlan", b =>
                {
                    b.HasBaseType("SmartTutor.ContentModel.Subscriptions.SubscriptionPlan");

                    b.HasDiscriminator().HasValue("IndividualPlan");
                });
            ...
            modelBuilder.Entity("SmartTutor.ContentModel.Subscriptions.IndividualPlanUsage", b =>
                {
                    b.HasOne("SmartTutor.ContentModel.Subscriptions.IndividualPlan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartTutor.ContentModel.Subscriptions.Subscription", b =>
                {
                    b.HasOne("SmartTutor.ContentModel.Subscriptions.IndividualPlanUsage", "PlanUsage")
                        .WithMany()
                        .HasForeignKey("PlanUsageId");
