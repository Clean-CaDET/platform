...
namespace DataSetExplorer.Core.DataSets
{
    internal class CaDETToDataSetProjectBuilder
    {
        ...
        internal CaDETToDataSetProjectBuilder(InstanceFilter instanceFilter, string projectAndCommitUrl, string projectName, string projectPath, List<string> foldersToIgnore, LanguageEnum language, bool includeClasses, bool includeMembers, List<CodeSmell> codeSmells)
        {
            _instanceFilter = instanceFilter;
            _projectAndCommitUrl = projectAndCommitUrl;
            _projectName = projectName;
            _cadetProject = new CodeModelFactory(language).CreateProjectWithCodeFileLinks(projectPath, foldersToIgnore);
            _includeClasses = includeClasses;
            _includeMembers = includeMembers;
            _codeSmells = codeSmells;
        }

        internal CaDETToDataSetProjectBuilder(InstanceFilter instanceFilter, string projectAndCommitUrl, string projectName, string projectPath, List<string> foldersToIgnore, List<CodeSmell> codeSmells): this(instanceFilter, projectAndCommitUrl, projectName, projectPath, foldersToIgnore, LanguageEnum.CSharp, true, true, codeSmells) { }
